...
void gcribbage_table_handle_resize(GCribbageTable *table, int width, int height, gpointer userdata) {
    ...
    table->layout_options.middle_offset = height / 2 - table->layout_options.card_height / 2;
    table->layout_options.bottom_offset = height - 25 - table->layout_options.card_height;
    render_buffer(table);
}
...
static void gcribbage_table_init(GCribbageTable *table) {
    ...
    table->layout_options.card_width = gdk_pixbuf_get_width(table->layout_options.card_images) / 13;
    table->layout_options.card_height = gdk_pixbuf_get_height(table->layout_options.card_images) / 4;
